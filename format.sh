...
# Print the help
function show_help {
    echo -e "This script formats this repo according to Google style"
    echo -e "  -h, --help \t Show this help"
    echo -e "  -t, --test \t Test if this repo is well formatted"
}
...
then
    ...
    # a SIGPIPE error.
    echo "Testing if this repo is correctly formatted"
